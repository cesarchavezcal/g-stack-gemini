/**
 * g-stack-gemini browse server — persistent Chromium daemon
 *
 * Architecture:
 ...
 *
 * State:
 *   State file: <project-root>/.g-stack-gemini/browse.json (set via BROWSE_STATE_FILE env)
 *   Log files:  <project-root>/.g-stack-gemini/browse-{console,network,dialog}.log
...
function generateHelpText(): string {
  ...
  const lines = ['g-stack-gemini browse — headless browser for AI agents', '', 'Commands:'];
