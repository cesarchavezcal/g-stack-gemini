/**
 * g-stack-gemini CLI — thin wrapper that talks to the persistent server
 *
 * Flow:
 *   1. Read .g-stack-gemini/browse.json for port + token
...
async function main() {
  ...
  if (args.length === 0 || args[0] === '--help' || args[0] === '-h') {
    console.log(`g-stack-gemini browse — Fast headless browser for AI coding agents
