...
export const E2E_TOUCHFILES: Record<string, string[]> = {
  ...
  'g-stack-gemini-upgrade-happy-path': ['g-stack-gemini-upgrade/**'],
...
export const LLM_JUDGE_TOUCHFILES: Record<string, string[]> = {
  ...
  'g-stack-gemini-upgrade/SKILL.md upgrade flow': ['g-stack-gemini-upgrade/SKILL.md', 'g-stack-gemini-upgrade/SKILL.md.tmpl'],
};
