...
describe('gen-skill-docs', () => {
  ...
  const ALL_SKILLS = [
    ...
    { dir: 'g-stack-gemini-upgrade', name: 'g-stack-gemini-upgrade' },
  ...
  test('generated SKILL.md contains contributor mode check', () => {
    ...
    expect(content).toContain('g_stack_gemini_contributor');
  ...
  test('generated SKILL.md contains telemetry line', () => {
    ...
    expect(content).toContain('~/.g-stack-gemini/analytics');
  });

  test('preamble-using skills have correct skill name in telemetry', () => {
    const PREAMBLE_SKILLS = [
      { dir: '.', name: 'g-stack-gemini' },
      { dir: 'ship', name: 'ship' },
      { dir: 'review', name: 'review' },
      { dir: 'qa', name: 'qa' },
      { dir: 'retro', name: 'retro' },
...
describe('REVIEW_DASHBOARD resolver', () => {
  ...
  for (const skill of REVIEW_SKILLS) {
    test(`review dashboard appears in ${skill} generated file`, () => {
      ...
      expect(content).toContain('g-stack-gemini-review');
